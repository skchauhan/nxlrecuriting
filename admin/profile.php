		        	...
		        	<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					  <div class="box-body">
					    ...
					    <div class="form-group">
					      ...
					      <input type="text" class="form-control" id="firstname" placeholder="Enter School Name" name="school" value="<?php echo !empty($arrOneUserDetail['school']) ? $arrOneUserDetail['school'] : ''; ?>">
					    </div>
					    <div class="form-group">
					      <label for="firstname">Sports Coached*</label>
					      <input type="text" class="form-control" id="firstname" placeholder="Enter Sports Coached" name="sports_coached" value="<?php echo !empty($arrOneUserDetail['sports_coached']) ? $arrOneUserDetail['sports_coached'] : ''; ?>">
					    </div>
					    <div class="form-group">
