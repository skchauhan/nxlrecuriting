...
<?php 
  $arrAllUsers = getAllUsers('athlete');
?>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
            <a href="add_athlete.php" class="btn btn-primary">Add New Athlete</a>
            <br>  
                  ...
                  ?>
                    <tr class="coach-row">
                      ...
                      <td><?php 
                        ...
                        echo "<a href='edit_athlete.php?uid=".$arrUser['id']."' class='btn btn-primary'>Edit</a> &nbsp;";
